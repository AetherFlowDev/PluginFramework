...
{
    public class CheckGenericVariantInstance : SpecificationBase
    {
        [OneTimeSetUp]
        public void Run()
        {
        ...
        public override void Act()
        {
            ...
            container.UseVariant<IConverter<Guid, string>>("Other");
        ...
        {
            Assert.That(_example, Is.InstanceOf<GuidConverterVariant>());
        }
    }
}